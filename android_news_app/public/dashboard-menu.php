             ...
             <div class="row">
                ...
                <a href="manage-category.php">
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="dash-item-ui card demo-color-box bg-blue waves-effect col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <br>
                            <div class="dash-item-title"><span>Manage Category</span></div>
                            <div class="color-name dash-middle"><?php echo $total_category; ?></div>
               ...
               <a href="manage-news.php">
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="dash-item-ui card demo-color-box bg-blue waves-effect col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <br>
                            <div class="dash-item-title"><span>Manage News</span></div>
                            <div class="color-name dash-middle"><?php echo $total_news; ?></div>
                ...
                <a href="push-notification.php">
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="dash-item-ui card demo-color-box bg-blue waves-effect col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <br>
                            <div class="dash-item-title"><span>Notification</span></div>
                            <div class="color-name dash-middle"><?php echo $total_fcm; ?></div>
                ...
                <a href="registered-user.php">
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="dash-item-ui card demo-color-box bg-blue waves-effect col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <br>
                            <div class="dash-item-title"><span>Registered User</span></div>
                            <div class="color-name dash-middle"><?php echo $total_users; ?></div>
                ...
                <a href="members.php">
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="dash-item-ui card demo-color-box bg-blue waves-effect col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <br>
                            <div class="dash-item-title"><span>Administrator</span></div>
                            <div class="color-name dash-middle"><i style="color:purple; font-size:25px;" class="material-icons">people</i></div>
                ...
                <a href="settings.php">
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="dash-item-ui card demo-color-box bg-blue waves-effect col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <br>
                            <div class="dash-item-title"><span>Settings</span></div>
                            <div class="color-name dash-middle"><i style="color:#000; font-size:25px;" class="material-icons">settings</i></div>
