...
<!--     <div class="search-bar">
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <div class="navbar-brand-name"><img style="float:left" class="navbar-img" src="assets/images/android.png"><a class="navbar-brand" href="dashboard.php"><span>android</span> News App</a></div>
            </div>
            <div class="collapse navbar-collapse" id="navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    <!-- Call Search -->
                    <li><a class="hvr-buzz-out" href="push-notification.php"><i style="color:#FFB64D;" class="material-icons bell">notifications</i></a></li>
                    <!-- #END# Call Search -->
                    <!-- Notifications -->
                    <li class="dropdown-more">
                        ...
                        <ul class="dropdown-menu drop-more">
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            <!-- User Info -->
            <div class="user-info">
                <div class="info-container user-logo">
                    <div class="">
