                ...
                <form method="POST">
                    ...
                    <div class="input-group">
                        <span class="input-group-addon">
                            <i style="color: #57b846;" class="material-icons">person</i>
                        </span>
                        <div class="form-line">
                    ...
                    <div class="input-group">
                        <span class="input-group-addon">
                            <i style="color: #f90048;" class="material-icons">lock</i>
                        </span>
                        <div class="form-line">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-4">
                            <button class="login-btn" type="submit" name="btnLogin">Login</button>
                        </div>
                    </div>
                </form>
            </div>
